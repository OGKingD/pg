...
<head>
    ...
    <link id="pagestyle" href="../../assets/css/soft-ui-dashboard.min.css%3Fv=1.0.9.css" rel="stylesheet" />
...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto h-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            <li class="nav-item">
                <a data-bs-toggle="collapse" href="smart-home.html#dashboardsExamples" class="nav-link active" aria-controls="dashboardsExamples" role="button" aria-expanded="false">
                ...
                <div class="collapse  show " id="dashboardsExamples">
                    <ul class="nav ms-4 ps-3">
                        ...
                        <li class="nav-item active">
                            <a class="nav-link active" href="smart-home.html">
                                <span class="sidenav-mini-icon"> S </span>
                                <span class="sidenav-normal"> Smart Home </span>
                            </a>
                        </li>
                        <li class="nav-item ">
                            <a class="nav-link " data-bs-toggle="collapse" aria-expanded="false" href="smart-home.html#vrExamples">
            ...
            <li class="nav-item">
                <a data-bs-toggle="collapse" href="smart-home.html#pagesExamples" class="nav-link " aria-controls="pagesExamples" role="button" aria-expanded="false">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
                ...
                <div class="collapse " id="pagesExamples">
                    <ul class="nav ms-4 ps-3">
                        <li class="nav-item ">
                            <a class="nav-link " data-bs-toggle="collapse" aria-expanded="false" href="smart-home.html#profileExample">
                        ...
                        <li class="nav-item ">
                            <a class="nav-link " data-bs-toggle="collapse" aria-expanded="false" href="smart-home.html#usersExample">
                        ...
                        <li class="nav-item ">
                            <a class="nav-link " data-bs-toggle="collapse" aria-expanded="false" href="smart-home.html#accountExample">
                                <span class="sidenav-mini-icon"> A </span>
                        ...
                        <li class="nav-item ">
                            <a class="nav-link " data-bs-toggle="collapse" aria-expanded="false" href="smart-home.html#projectsExample">
                                <span class="sidenav-mini-icon"> P </span>
            ...
            <li class="nav-item">
                <a data-bs-toggle="collapse" href="smart-home.html#applicationsExamples" class="nav-link " aria-controls="applicationsExamples" role="button" aria-expanded="false">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
            ...
            <li class="nav-item">
                <a data-bs-toggle="collapse" href="smart-home.html#ecommerceExamples" class="nav-link " aria-controls="ecommerceExamples" role="button" aria-expanded="false">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
                ...
                <div class="collapse " id="ecommerceExamples">
                    <ul class="nav ms-4 ps-3">
                        ...
                        <li class="nav-item ">
                            <a class="nav-link " data-bs-toggle="collapse" aria-expanded="false" href="smart-home.html#productsExample">
                                <span class="sidenav-mini-icon"> P </span>
                        ...
                        <li class="nav-item ">
                            <a class="nav-link " data-bs-toggle="collapse" aria-expanded="false" href="smart-home.html#ordersExample">
                                <span class="sidenav-mini-icon"> O </span>
            ...
            <li class="nav-item">
                <a data-bs-toggle="collapse" href="smart-home.html#authExamples" class="nav-link " aria-controls="authExamples" role="button" aria-expanded="false">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
                ...
                <div class="collapse " id="authExamples">
                    <ul class="nav ms-4 ps-3">
                        <li class="nav-item ">
                            <a class="nav-link " data-bs-toggle="collapse" aria-expanded="false" href="smart-home.html#signinExample">
                                <span class="sidenav-mini-icon"> S </span>
                        ...
                        <li class="nav-item ">
                            <a class="nav-link " data-bs-toggle="collapse" aria-expanded="false" href="smart-home.html#signupExample">
                                <span class="sidenav-mini-icon"> S </span>
                        ...
                        <li class="nav-item ">
                            <a class="nav-link " data-bs-toggle="collapse" aria-expanded="false" href="smart-home.html#resetExample">
                                <span class="sidenav-mini-icon"> R </span>
                        ...
                        <li class="nav-item ">
                            <a class="nav-link " data-bs-toggle="collapse" aria-expanded="false" href="smart-home.html#lockExample">
                        ...
                        <li class="nav-item ">
                            <a class="nav-link " data-bs-toggle="collapse" aria-expanded="false" href="smart-home.html#StepExample">
                        ...
                        <li class="nav-item ">
                            <a class="nav-link " data-bs-toggle="collapse" aria-expanded="false" href="smart-home.html#errorExample">
            ...
            <li class="nav-item">
                <a data-bs-toggle="collapse" href="smart-home.html#basicExamples" class="nav-link " aria-controls="basicExamples" role="button" aria-expanded="false">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
                ...
                <div class="collapse " id="basicExamples">
                    <ul class="nav ms-4 ps-3">
                        <li class="nav-item ">
                            <a class="nav-link " data-bs-toggle="collapse" aria-expanded="false" href="smart-home.html#gettingStartedExample">
                        ...
                        <li class="nav-item ">
                            <a class="nav-link " data-bs-toggle="collapse" aria-expanded="false" href="smart-home.html#foundationExample">
            ...
            <li class="nav-item">
                <a data-bs-toggle="collapse" href="smart-home.html#componentsExamples" class="nav-link " aria-controls="componentsExamples" role="button" aria-expanded="false">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
                    ...
                    <div class="card-header d-flex pb-0 p-3">
                        ...
                        <div class="nav-wrapper position-relative ms-auto w-50">
                            <ul class="nav nav-pills nav-fill p-1" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link mb-0 px-0 py-1 active" data-bs-toggle="tab" href="smart-home.html#cam1" role="tab" aria-controls="cam1" aria-selected="true">
                                        Kitchen
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link mb-0 px-0 py-1" data-bs-toggle="tab" href="smart-home.html#cam2" role="tab" aria-controls="cam2" aria-selected="false">
                                        Living
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link mb-0 px-0 py-1" data-bs-toggle="tab" href="smart-home.html#cam3" role="tab" aria-controls="cam3" aria-selected="false">
                                        Attic
                                    </a>
                                </li>
                            </ul>
...
<script src="../../assets/js/soft-ui-dashboard.min.js%3Fv=1.0.9"></script>
</body>
</html>
