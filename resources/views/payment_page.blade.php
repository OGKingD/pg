...
<main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <div class="container-fluid py-3 col-lg-9 mx-auto">
        <div class="card">
            @livewire('payment-page', ['invoice' => $invoice, 'merchantGateways' => $merchantGateways, 'activeTab' => $activeTab, 'merchantAvatar' => $merchantAvatar, 'merchantSettings' => $merchantSettings])
        </div>
