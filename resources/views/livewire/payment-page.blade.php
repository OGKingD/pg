    ...
    <div class="row">
        <div class="col-md-3">
            <div class="border-right">
                ...
                <ul class="nav nav-pills flex-column " role="tablist">
                    ...
                    @endif
                    @if(isset($merchantGateways['qrcode']))
                        <li class="nav-item" onclick="setActiveTab('qrcode')">
                            <a class="nav-link mt-1 @if($activeTab === "qrcode") active @endif"
                               data-bs-toggle="pill"
                               href="#qrcode">
        ...
        <div class="col-md-9">
            ...
            <div class="tab-content min-vh-55">
                                                    ...
                                                    <ul class="list-group " style="font-size: 14px">
                                                        <li class="list-group-item d-flex align-items-center">
                                                            ...
                                                            <div
                                                                ...
                                                                <p style="word-break: break-word; font-size: 18px"
                                                        ...
                                                        <li class="list-group-item d-flex align-items-center">
                                                            ...
                                                            <div
                                                                ...
                                                                <p style="word-break: break-word; font-size: 18px"
                                                                   class="text-xl font-weight-bolder text-secondary mb-0">{{$virtualAccDetails['accountName']}}</p>
                                                            </div>
                                                            ...
                                                            <div
                                                                ...
                                                                <p style="word-break: break-word; font-size: 18px"
                                                                   class="text-xl font-weight-bolder text-secondary mb-0">
                                                                    ...
                                                                    {{number_format($merchantGateways[$activeTab]['invoiceTotal'],2)}}
                                                                    ({{$invoice->transaction->currency}})</p>
                                                            </div>
                ...
                @if(isset($merchantGateways['qrcode']))
                    <div id="qrcode"
                         class="container tab-pane  @if($activeTab === "qrcode") active  @endif">
                        <br>
                        <div class="text-center mt-3">
                            <h3 class="text-secondary font-weight-normal">Pay Using QR Code.</h3>

                            @if(empty($qRCodeDetails))
                                <div id="genQRCodestep1">
                                    <div class="col-sm-3 mx-auto mt-4">
                                        <input type="button" class="btn-check" id="generateQRCode">
                                        <label class="btn btn-lg btn-outline-secondary border-2 px-6 py-5"
                                               for="btncheck2"
                            ...
                            <div id="genQRCodestep2" class=" mt-2" tabindex="0">
                                <div class=" mx-auto card  word-break ">
                                    <div class="card-body pt-4 text-start ">
                                        @if(!empty($qRCodeDetails))
                                            <div class="row" id="qRCodeDisplayContent">

                                                <div
                                                    class="alert alert-info alert-dismissible fade show  text-white "
                                                    role="alert">
                                                        <span class="alert-icon"><i
                                                                class="fa fa-info-circle"></i></span>
                                                    <span class="alert-text font-weight-bold">
                                                                Scan QR Code using QR Payment option of your preferred banking app
                                                            </span>

                                                </div>
                                                <div class="card pb-6" tabindex="0" style="align-items: center">
                                                    <div>
                                                        <img height="200px" width="200px" src="{{"https://api.qrserver.com/v1/create-qr-code/?data=".urlencode($qRCodeDetails['qr_code'])}}" alt="QRCode Image"/>
                                                    </div>
                                                ...
                                                <div class="mt-4">
                                                    <ul class="list-group " style="font-size: 14px">
                                                        ...
                                                        <li class="list-group-item d-flex justify-content-between align-items-center">
                                                            <b class="text-danger">This is a one-off qr code,
                                                                do not save or re-use it</b>
                                                            <span class="badge badge-warning badge-pill"><i
                                                                    class="fa fa-info text-info"></i></span>
                                                        </li>
        ...
        <script>
            ...
            function generateQRCode() {
                Swal.fire({
                    title: 'Generating QR Code ! Please wait!',
                    html: '  <span class="spinner-border spinner-border-lg text-primary"></span>\n',
                    allowEscapeKey: false,
                    showConfirmButton: false,
                    allowOutsideClick: false,
            ...
            addEventListener('qRCodeGenerated', event => {

                let response = event.detail;

                if (response.status === true) {
                    document.getElementById('genQRCodestep2').style.display = "block";

                    salert('QR Code GENERATED SUCCESSFULLY', 'success', 'success');
