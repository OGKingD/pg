                            ...
                            c3.1-3.2,4.8-7.4,4.8-11.8C142.4,78.4,134.8,70.8,125.5,70.8z"/>
                                    ...
                                    <div class="col-12 text-center">
                                        <button class="btn btn-success btn-lg btn-block"
                                                type="submit">Pay {{$invoiceTotal}} NGN
                                        </button>
                                    </div>
                                @endif
                                            ...
                                            <div class="card-body text-center">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input class="form-control" placeholder="****" id="pin"
                                                           type="password"
                                                           pattern="[0-9]*" name="pin" wire:model.lazy="cc_Pin"></div>
                                            ...
                                            <div class="card-body text-center">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input class="form-control" placeholder="****" id="otp"
                                                           type="password"
                                                           pattern="[0-9]*" name="otp" wire:model.lazy="cc_Otp"></div>
                                                <div class="text-center">
                                                    <button type="button" class="btn btn-lg bg-gradient-dark mt-3 mb-0"
    ...
    <script>
        ...
        addEventListener('cardPaymentProcessed', event => {
            ...
            if (response.status === true) {
                ...
                return salert('Payment Failed!', "Payment Failed! Please Try Again or Use another Payment Channel!", 'error');
        ...
        function getUssdAccountDetails() {
            ...
            {{--axios.post('getussddetails',{"key" : "{{env('APP_KEY')}}", "bank" : selectedBank , "amount" : "{{$total}}"} ).then(response => {--}}

            {{--    let result = response.data;--}}

            {{--    if (!result.status) {--}}
            {{--        throw new Error("Error Fetching Details, Please Try again");--}}
            {{--    }--}}
            {{--    //--}}
            {{--    document.getElementById('bankUssd').style.display = "block";--}}
            {{--    document.getElementById('ussdAccount').innerText = result.code--}}
            {{--    document.getElementById('ussdAccountText').innerText = result.message--}}
