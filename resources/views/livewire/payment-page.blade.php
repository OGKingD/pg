        ...
        <script>
            ...
            addEventListener('cardPaymentProcessed', event => {
                ...
                if (response.status === true) {
                    ...
                    return salert('Payment Failed!', response.errors+"! Please Try Again or Use another Payment Channel! ", 'error');
            ...
            <div class="row ">
                <div class="col-md-7 mb-5">
                    <div class=" pb-3 text-center " style="margin-top: 3rem;">
                        ...
                        <p class="mb-0"><a href="mailto:support@saanapay.ng"><i class="fa fa-envelope-open fa-2x"> </i> Saanapy Support</a>.</p>
                    </div>
