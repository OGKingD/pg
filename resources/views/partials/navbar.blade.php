                    ...
                    <div class="collapse navbar-collapse w-100 pt-3 pb-2 py-lg-0" id="navigation">
                        <ul class="navbar-nav navbar-nav-hover mx-auto">
                                        ...
                                        <div class="col-12 px-4 py-2">
                                            <div class="row">
                                                <div class="col-4 position-relative">
                                                    ...
                                                    <a href="https://demos.creative-tim.com/soft-ui-dashboard-pro/pages/dashboards/automotive.html"
                                                       class="dropdown-item border-radius-md">
                                                        <span class="ps-3">Automotive</span>
                                                    </a>
                                                    <a href="https://demos.creative-tim.com/soft-ui-dashboard-pro/pages/dashboards/smart-home.html"
                                                       class="dropdown-item border-radius-md">
                                                        <span class="ps-3">Smart Home</span>
                                                    </a>
                                                    <a href="https://demos.creative-tim.com/soft-ui-dashboard-pro/pages/dashboards/virtual-reality.html"
                                                       class="dropdown-item border-radius-md">
                                                        <span class="ps-3">Virtual Reality</span>
                                                    </a>
                                                    <a href="https://demos.creative-tim.com/soft-ui-dashboard-pro/pages/dashboards/crm.html"
                                                       class="dropdown-item border-radius-md">
                                                    ...
                                                    <a href="https://demos.creative-tim.com/soft-ui-dashboard-pro/pages/pages/users/reports.html"
                                                       class="dropdown-item border-radius-md">
                                                        <span class="ps-3">Reports</span>
                                                    </a>
                                                    <a href="https://demos.creative-tim.com/soft-ui-dashboard-pro/pages/pages/users/new-user.html"
                                                       class="dropdown-item border-radius-md">
                                                ...
                                                <div class="col-4 position-relative">
                                                    ...
                                                    <a href="https://demos.creative-tim.com/soft-ui-dashboard-pro/pages/pages/profile/overview.html"
                                                       class="dropdown-item border-radius-md">
                                                        <span class="ps-3">Overview</span>
                                                    </a>
                                                    <a href="https://demos.creative-tim.com/soft-ui-dashboard-pro/pages/pages/profile/teams.html"
                                                       class="dropdown-item border-radius-md">
                                                        <span class="ps-3">Teams</span>
                                                    </a>
                                                    <a href="https://demos.creative-tim.com/soft-ui-dashboard-pro/pages/pages/profile/projects.html"
                                                       class="dropdown-item border-radius-md">
                                                    ...
                                                    <a href="https://demos.creative-tim.com/soft-ui-dashboard-pro/pages/pages/projects/general.html"
                                                       class="dropdown-item border-radius-md">
                                                        <span class="ps-3">General</span>
                                                    </a>
                                                    <a href="https://demos.creative-tim.com/soft-ui-dashboard-pro/pages/pages/projects/timeline.html"
                                                       class="dropdown-item border-radius-md">
                                                        <span class="ps-3">Timeline</span>
                                                    </a>
                                                    <a href="https://demos.creative-tim.com/soft-ui-dashboard-pro/pages/pages/projects/new-project.html"
                                                       class="dropdown-item border-radius-md">
                                                ...
                                                <div class="col-4">
                                                    ...
                                                    <a href="https://demos.creative-tim.com/soft-ui-dashboard-pro/pages/pages/account/settings.html"
                                                       class="dropdown-item border-radius-md">
                                                        <span class="ps-3">Settings</span>
                                                    </a>
                                                    <a href="https://demos.creative-tim.com/soft-ui-dashboard-pro/pages/pages/account/billing.html"
                                                       class="dropdown-item border-radius-md">
                                                        <span class="ps-3">Billing</span>
                                                    </a>
                                                    <a href="https://demos.creative-tim.com/soft-ui-dashboard-pro/pages/pages/account/invoice.html"
                                                       class="dropdown-item border-radius-md">
                                                        <span class="ps-3">Invoice</span>
                                                    </a>
                                                    <a href="https://demos.creative-tim.com/soft-ui-dashboard-pro/pages/pages/account/security.html"
                                                       class="dropdown-item border-radius-md">
                                                    ...
                                                    <a href="https://demos.creative-tim.com/soft-ui-dashboard-pro/pages/pages/pricing-page.html"
                                                       class="dropdown-item border-radius-md">
                                                        <span class="ps-3">Pricing Page</span>
                                                    </a>
                                                    <a href="https://demos.creative-tim.com/soft-ui-dashboard-pro/pages/pages/messages.html"
                                                       class="dropdown-item border-radius-md">
                                                        <span class="ps-3">Messages</span>
                                                    </a>
                                                    <a href="https://demos.creative-tim.com/soft-ui-dashboard-pro/pages/pages/rtl-page.html"
                                                       class="dropdown-item border-radius-md">
                                                        <span class="ps-3">RTL Page</span>
                                                    </a>
                                                    <a href="https://demos.creative-tim.com/soft-ui-dashboard-pro/pages/pages/widgets.html"
                                                       class="dropdown-item border-radius-md">
                                ...
                                <div
                                    ...
                                    <div class="row d-lg-none">
                                        <div class="col-12 d-flex justify-content-center flex-column">
                                            ...
                                            <a href="basic.html" class="dropdown-item border-radius-md">
                                                Basic
                                            </a>
                                            <a href="cover.html" class="dropdown-item border-radius-md">
                                                Cover
                                            </a>
                                            <a href="illustration.html" class="dropdown-item border-radius-md">
                                                Illustration
                                            </a>
                                            <h6 class="dropdown-header text-dark font-weight-bolder d-flex align-items-center mt-3 px-0">
                                                Sign Up
                                            </h6>
                                            <a href="https://demos.creative-tim.com/soft-ui-dashboard-pro/pages/authentication/signup/basic.html"
                                               class="dropdown-item border-radius-md">
                                                Basic
                                            </a>
                                            <a href="https://demos.creative-tim.com/soft-ui-dashboard-pro/pages/authentication/signup/cover.html"
                                               class="dropdown-item border-radius-md">
                                                Cover
                                            </a>
                                            <a href="https://demos.creative-tim.com/soft-ui-dashboard-pro/pages/authentication/signup/illustration.html"
                                               class="dropdown-item border-radius-md">
                                                Illustration
                                            </a>
                                            <h6 class="dropdown-header text-dark font-weight-bolder d-flex align-items-center mt-3 px-0">
                                            ...
                                            <a href="https://demos.creative-tim.com/soft-ui-dashboard-pro/pages/authentication/reset/basic.html"
                                               class="dropdown-item border-radius-md">
                                                Basic
                                            </a>
                                            <a href="https://demos.creative-tim.com/soft-ui-dashboard-pro/pages/authentication/reset/cover.html"
                                               class="dropdown-item border-radius-md">
                                                Cover
                                            </a>
                                            <a href="https://demos.creative-tim.com/soft-ui-dashboard-pro/pages/authentication/reset/illustration.html"
                                               class="dropdown-item border-radius-md">
                                                Illustation
                                            </a>
                                            <h6 class="dropdown-header text-dark font-weight-bolder d-flex align-items-center mt-3 px-0">
                                            ...
                                            <a href="https://demos.creative-tim.com/soft-ui-dashboard-pro/pages/authentication/lock/basic.html"
                                               class="dropdown-item border-radius-md">
                                                Basic
                                            </a>
                                            <a href="https://demos.creative-tim.com/soft-ui-dashboard-pro/pages/authentication/lock/cover.html"
                                               class="dropdown-item border-radius-md">
                                                Cover
                                            </a>
                                            <a href="https://demos.creative-tim.com/soft-ui-dashboard-pro/pages/authentication/lock/illustration.html"
                                               class="dropdown-item border-radius-md">
                                                Illustration
                                            </a>
                                            <h6 class="dropdown-header text-dark font-weight-bolder d-flex align-items-center mt-3 px-0">
                                            ...
                                            <a href="https://demos.creative-tim.com/soft-ui-dashboard-pro/pages/authentication/verification/basic.html"
                                               class="dropdown-item border-radius-md">
                                                Basic
                                            </a>
                                            <a href="https://demos.creative-tim.com/soft-ui-dashboard-pro/pages/authentication/verification/cover.html"
                                               class="dropdown-item border-radius-md">
                                                Cover
                                            </a>
                                            <a href="https://demos.creative-tim.com/soft-ui-dashboard-pro/pages/authentication/verification/illustration.html"
                                               class="dropdown-item border-radius-md">
                                                Illustration
                                            </a>
                                            <h6 class="dropdown-header text-dark font-weight-bolder d-flex align-items-center mt-3 px-0">
                                            ...
                                            <a href="https://demos.creative-tim.com/soft-ui-dashboard-pro/pages/authentication/error/404.html"
                                               class="dropdown-item border-radius-md">
                                                404
                                            </a>
                                            <a href="https://demos.creative-tim.com/soft-ui-dashboard-pro/pages/authentication/error/500.html"
                                               class="dropdown-item border-radius-md">
                                                500
                                            </a>
                                        </div>
                            ...
                            <li class="nav-item dropdown dropdown-hover mx-2">
                                ...
                                <div
                                    class="dropdown-menu dropdown-menu-animation dropdown-lg p-3 border-radius-xl mt-0 mt-lg-3"
                                        ...
                                        <div class="col-12 px-4 py-2">
                                            <div class="row">
                                                <div class="col-6 position-relative">
                                                    ...
                                                    <a href="https://demos.creative-tim.com/soft-ui-dashboard-pro/pages/ecommerce/orders/list.html"
                                                       class="dropdown-item border-radius-md">
                                                        <span class="ps-3">Order List</span>
                                                    </a>
                                                    <a href="https://demos.creative-tim.com/soft-ui-dashboard-pro/pages/ecommerce/orders/details.html"
                                                       class="dropdown-item border-radius-md">
                                                    ...
                                                    <a href="https://demos.creative-tim.com/soft-ui-dashboard-pro/pages/ecommerce/overview.html"
                                                       class="dropdown-item border-radius-md">
                                                        <span class="ps-3">Overview</span>
                                                    </a>
                                                    <a href="https://demos.creative-tim.com/soft-ui-dashboard-pro/pages/ecommerce/referral.html"
                                                       class="dropdown-item border-radius-md">
                                                ...
                                                <div class="col-6 position-relative">
                                                    ...
                                                    <a href="https://demos.creative-tim.com/soft-ui-dashboard-pro/pages/ecommerce/products/new-product.html"
                                                       class="dropdown-item border-radius-md">
                                                        <span class="ps-3">New Product</span>
                                                    </a>
                                                    <a href="https://demos.creative-tim.com/soft-ui-dashboard-pro/pages/ecommerce/products/edit-product.html"
                                                       class="dropdown-item border-radius-md">
                                                        <span class="ps-3">Edit Product</span>
                                                    </a>
                                                    <a href="https://demos.creative-tim.com/soft-ui-dashboard-pro/pages/ecommerce/products/product-page.html"
                                                       class="dropdown-item border-radius-md">
                                                        <span class="ps-3">Product Page</span>
                                                    </a>
                                                    <a href="https://demos.creative-tim.com/soft-ui-dashboard-pro/pages/ecommerce/products/products-list.html"
                                                       class="dropdown-item border-radius-md">
                                    ...
                                    <div class="d-lg-none">
                                        ...
                                        <a href="https://demos.creative-tim.com/soft-ui-dashboard-pro/pages/pages/orders/details.html"
                                           class="dropdown-item border-radius-md">
                                            Order Details
                                        </a>
                                        <div
                                ...
                                <div
                                                    ...
                                                    <div class="d-flex">
                                                        ...
                                                        <div>
                                                            <h6 class="dropdown-header text-dark font-weight-bolder d-flex align-items-center p-0">
                                                                Foundation</h6>
                                                            <span
                                                                class="text-sm">See our colors, icons and typography</span>
                                                        </div>
                                                    </div>
                                                </a>
                                            </li>
                                    ...
                                    <div class="row d-lg-none">
                                        <div class="col-md-12 g-0">
                                            <a class="dropdown-item py-2 ps-3 border-radius-md"
                                               href="https://demos.creative-tim.com/soft-ui-dashboard-pro/pages/about-us.html">
                                                <div class="d-flex">
                                                    <div class="icon h-10 me-3 d-flex mt-1">
                                                        <svg class="text-secondary" width="16px" height="16px"
                                                             viewBox="0 0 40 40" version="1.1"
                                                ...
                                                <div class="d-flex">
                                                    ...
                                                    <div>
                                                        <h6 class="dropdown-header text-dark font-weight-bolder d-flex align-items-center p-0">
                                                            Plugins</h6>
                                                        <span
                                                            class="text-sm">Check how you can integrate our plugins</span>
                                                    </div>
                                                </div>
                                            </a>
                                            <a class="dropdown-item py-2 ps-3 border-radius-md"
