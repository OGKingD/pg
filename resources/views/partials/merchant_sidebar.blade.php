<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="#" target="_blank">
            <img src="{{asset('assets/img/saanapay.png')}}" class="navbar-brand-img h-100" alt="main_logo">
        </a>
    </div>
            ...
            <div class="card-body text-start p-3 w-100">
                <div class="row">
                    ...
                    <div class="col-8 docs-info">
                        <span class="text-white up mb-0">Hello {{auth()->user()->first_name }}! Welcome.</span>
                    </div>
                </div>
    ...
    <div class="collapse navbar-collapse  w-auto h-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link @if(request()->path() === "transactions") active @endif" href="#" >
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
                        <i class="fas fa-file-invoice-dollar @if(request()->path() === "transactions") text-white @else text-dark @endif"></i>
                    </div>
            ...
            <li class="nav-item">
                ...
                <h6 class="ps-4  ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Collect Payments</h6>
            </li>
            <li class="nav-item">
                <a class="nav-link @if(request()->path() === "invoice") active @endif" href="{{route('invoice.listing')}}" >
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
                        <i class="fas fa-file-invoice-dollar @if(request()->path() === "invoice") text-white @else text-dark @endif"></i>
                    </div>
                    <span class="nav-link-text ms-1">Invoice</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link @if(request()->path() === "transactions/request_money") active @endif" href="#" >
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
                        <i class="fas fa-file-invoice-dollar @if(request()->path() === "transactions") text-white @else text-dark @endif"></i>
                    </div>
