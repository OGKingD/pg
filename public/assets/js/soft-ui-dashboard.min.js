...
function darkMode(e) {
    const t = document.getElementsByTagName("body")[0], a = document.querySelectorAll("div:not(.sidenav) > hr"),
        ...
        c = document.querySelectorAll("strong.text-dark"), d = document.querySelectorAll("strong.text-white"),
        u = document.querySelectorAll("a.nav-link.text-dark"), g = document.querySelectorAll(".text-secondary"),
        m = document.querySelectorAll(".text-white"), v = document.querySelectorAll(".bg-gray-100"),
        ...
        y = document.querySelectorAll(".card.border"), p = document.querySelectorAll(".card.border.border-dark"),
        x = document.querySelectorAll(".navbar g"), w = document.querySelector(".navbar-brand-img"), L = w.src,
