...
class DatabaseSeeder extends Seeder
{
    ...
    public function seedOtherTables()
    {
        DB::unprepared(<<<TAG

INSERT INTO `currencies` (`country`, `currency`, `name`, `symbol`, `rate`, `status`) VALUES
('Albania', 'Leke', 'ALL', 'Lek', NULL, '0'),
('Afghanistan', 'Afghanis', 'AFN', '؋', NULL, '0'),
('Argentina', 'Pesos', 'ARS', '\$', NULL, '0'),
('Aruba', 'Guilders', 'AWG', 'ƒ', NULL, '0'),
('Australia', 'Dollars', 'AUD', '\$', NULL, '0'),
('Azerbaijan', 'New Manats', 'AZN', 'ман', NULL, '0'),
('Bahamas', 'Dollars', 'BSD', '\$', NULL, '0'),
('Barbados', 'Dollars', 'BBD', '\$', NULL, '0'),
('Belarus', 'Rubles', 'BYR', 'p.', NULL, '0'),
('Belgium', 'Euro', 'EUR', '€', NULL, '0'),
('Beliz', 'Dollars', 'BZD', 'BZ\$', NULL, '0'),
('Bermuda', 'Dollars', 'BMD', '\$', NULL, '0'),
('Bolivia', 'Bolivianos', 'BOB', '\$b', NULL, '0'),
('Bosnia and Herzegovina', 'Convertible Marka', 'BAM', 'KM', NULL, '0'),
('Botswana', 'Pula', 'BWP', 'P', NULL, '0'),
('Bulgaria', 'Leva', 'BGN', 'лв', NULL, '0'),
('Brazil', 'Reais', 'BRL', 'R\$', NULL, '0'),
('Britain (United Kingdom)', 'Pounds', 'GBP', '£', NULL, '0'),
('Brunei Darussalam', 'Dollars', 'BND', '\$', NULL, '0'),
('Cambodia', 'Riels', 'KHR', '៛', NULL, '0'),
('Canada', 'Dollars', 'CAD', '\$', NULL, '0'),
('Cayman Islands', 'Dollars', 'KYD', '\$', NULL, '0'),
('Chile', 'Pesos', 'CLP', '\$', NULL, '0'),
('China', 'Yuan Renminbi', 'CNY', '¥', NULL, '0'),
('Colombia', 'Pesos', 'COP', '\$', NULL, '0'),
('Costa Rica', 'Colón', 'CRC', '₡', NULL, '0'),
('Croatia', 'Kuna', 'HRK', 'kn', NULL, '0'),
('Cuba', 'Pesos', 'CUP', '₱', NULL, '0'),
('Cyprus', 'Euro', 'EUR', '€', NULL, '0'),
('Czech Republic', 'Koruny', 'CZK', 'Kč', NULL, '0'),
('Denmark', 'Kroner', 'DKK', 'kr', NULL, '0'),
('Dominican Republic', 'Pesos', 'DOP ', 'RD\$', NULL, '0'),
('East Caribbean', 'Dollars', 'XCD', '\$', NULL, '0'),
('Egypt', 'Pounds', 'EGP', '£', NULL, '0'),
('El Salvador', 'Colones', 'SVC', '\$', NULL, '0'),
('England (United Kingdom)', 'Pounds', 'GBP', '£', NULL, '0'),
('Euro', 'Euro', 'EUR', '€', NULL, '0'),
('Falkland Islands', 'Pounds', 'FKP', '£', NULL, '0'),
('Fiji', 'Dollars', 'FJD', '\$', NULL, '0'),
('France', 'Euro', 'EUR', '€', NULL, '0'),
('Ghana', 'Cedis', 'GHS', '¢', NULL, '0'),
('Gibraltar', 'Pounds', 'GIP', '£', NULL, '0'),
('Greece', 'Euro', 'EUR', '€', NULL, '0'),
('Guatemala', 'Quetzales', 'GTQ', 'Q', NULL, '0'),
('Guernsey', 'Pounds', 'GGP', '£', NULL, '0'),
('Guyana', 'Dollars', 'GYD', '\$', NULL, '0'),
('Holland (Netherlands)', 'Euro', 'EUR', '€', NULL, '0'),
('Honduras', 'Lempiras', 'HNL', 'L', NULL, '0'),
('Hong Kong', 'Dollars', 'HKD', '\$', NULL, '0'),
('Hungary', 'Forint', 'HUF', 'Ft', NULL, '0'),
('Iceland', 'Kronur', 'ISK', 'kr', NULL, '0'),
('India', 'Rupees', 'INR', 'Rp', NULL, '0'),
('Indonesia', 'Rupiahs', 'IDR', 'Rp', NULL, '0'),
('Iran', 'Rials', 'IRR', '﷼', NULL, '0'),
('Ireland', 'Euro', 'EUR', '€', NULL, '0'),
('Isle of Man', 'Pounds', 'IMP', '£', NULL, '0'),
('Israel', 'New Shekels', 'ILS', '₪', NULL, '0'),
('Italy', 'Euro', 'EUR', '€', NULL, '0'),
('Jamaica', 'Dollars', 'JMD', 'J\$', NULL, '0'),
('Japan', 'Yen', 'JPY', '¥', NULL, '0'),
('Jersey', 'Pounds', 'JEP', '£', NULL, '0'),
('Kazakhstan', 'Tenge', 'KZT', 'лв', NULL, '0'),
('Korea (North)', 'Won', 'KPW', '₩', NULL, '0'),
('Korea (South)', 'Won', 'KRW', '₩', NULL, '0'),
('Kyrgyzstan', 'Soms', 'KGS', 'лв', NULL, '0'),
('Laos', 'Kips', 'LAK', '₭', NULL, '0'),
('Latvia', 'Lati', 'LVL', 'Ls', NULL, '0'),
('Lebanon', 'Pounds', 'LBP', '£', NULL, '0'),
('Liberia', 'Dollars', 'LRD', '\$', NULL, '0'),
('Liechtenstein', 'Switzerland Francs', 'CHF', 'CHF', NULL, '0'),
('Lithuania', 'Litai', 'LTL', 'Lt', NULL, '0'),
('Luxembourg', 'Euro', 'EUR', '€', NULL, '0'),
('Macedonia', 'Denars', 'MKD', 'ден', NULL, '0'),
('Malaysia', 'Ringgits', 'MYR', 'RM', NULL, '0'),
('Malta', 'Euro', 'EUR', '€', NULL, '0'),
('Mauritius', 'Rupees', 'MUR', '₨', NULL, '0'),
('Mexico', 'Pesos', 'MXN', '\$', NULL, '0'),
('Mongolia', 'Tugriks', 'MNT', '₮', NULL, '0'),
('Mozambique', 'Meticais', 'MZN', 'MT', NULL, '0'),
('Namibia', 'Dollars', 'NAD', '\$', NULL, '0'),
('Nepal', 'Rupees', 'NPR', '₨', NULL, '0'),
('Netherlands Antilles', 'Guilders', 'ANG', 'ƒ', NULL, '0'),
('Netherlands', 'Euro', 'EUR', '€', NULL, '0'),
('New Zealand', 'Dollars', 'NZD', '\$', NULL, '0'),
('Nicaragua', 'Cordobas', 'NIO', 'C\$', NULL, '0'),
('Nigeria', 'Nairas', 'NGN', '₦', '390', '1'),
('North Korea', 'Won', 'KPW', '₩', NULL, '0'),
('Norway', 'Krone', 'NOK', 'kr', NULL, '0'),
('Oman', 'Rials', 'OMR', '﷼', NULL, '0'),
('Pakistan', 'Rupees', 'PKR', '₨', NULL, '0'),
('Panama', 'Balboa', 'PAB', 'B/.', NULL, '0'),
('Paraguay', 'Guarani', 'PYG', 'Gs', NULL, '0'),
('Peru', 'Nuevos Soles', 'PEN', 'S/.', NULL, '0'),
('Philippines', 'Pesos', 'PHP', 'Php', NULL, '0'),
('Poland', 'Zlotych', 'PLN', 'zł', NULL, '0'),
('Qatar', 'Rials', 'QAR', '﷼', NULL, '0'),
('Romania', 'New Lei', 'RON', 'lei', NULL, '0'),
('Russia', 'Rubles', 'RUB', 'руб', NULL, '0'),
( 'Saint Helena', 'Pounds', 'SHP', '£', NULL, '0'),
( 'Saudi Arabia', 'Riyals', 'SAR', '﷼', NULL, '0'),
( 'Serbia', 'Dinars', 'RSD', 'Дин.', NULL, '0'),
( 'Seychelles', 'Rupees', 'SCR', '₨', NULL, '0'),
( 'Singapore', 'Dollars', 'SGD', '\$', NULL, '0'),
( 'Slovenia', 'Euro', 'EUR', '€', NULL, '0'),
( 'Solomon Islands', 'Dollars', 'SBD', '\$', NULL, '0'),
( 'Somalia', 'Shillings', 'SOS', 'S', NULL, '0'),
( 'South Africa', 'Rand', 'ZAR', 'R', NULL, '0'),
( 'South Korea', 'Won', 'KRW', '₩', NULL, '0'),
( 'Spain', 'Euro', 'EUR', '€', NULL, '0'),
( 'Sri Lanka', 'Rupees', 'LKR', '₨', NULL, '0'),
( 'Sweden', 'Kronor', 'SEK', 'kr', NULL, '0'),
( 'Switzerland', 'Francs', 'CHF', 'CHF', NULL, '0'),
( 'Suriname', 'Dollars', 'SRD', '\$', NULL, '0'),
( 'Syria', 'Pounds', 'SYP', '£', NULL, '0'),
( 'Taiwan', 'New Dollars', 'TWD', 'NT\$', NULL, '0'),
( 'Thailand', 'Baht', 'THB', '฿', NULL, '0'),
( 'Trinidad and Tobago', 'Dollars', 'TTD', 'TT\$', NULL, '0'),
( 'Turkey', 'Lira', 'TRY', 'TL', NULL, '0'),
( 'Turkey', 'Liras', 'TRL', '£', NULL, '0'),
( 'Tuvalu', 'Dollars', 'TVD', '\$', NULL, '0'),
( 'Ukraine', 'Hryvnia', 'UAH', '₴', NULL, '0'),
( 'United Kingdom', 'Pounds', 'GBP', '£', NULL, '0'),
( 'United States of America', 'Dollars', 'USD', '\$', NULL, '0'),
( 'Uruguay', 'Pesos', 'UYU', '\$U', NULL, '0'),
( 'Uzbekistan', 'Sums', 'UZS', 'лв', NULL, '0'),
( 'Vatican City', 'Euro', 'EUR', '€', NULL, '0'),
( 'Venezuela', 'Bolivares Fuertes', 'VEF', 'Bs', NULL, '0'),
( 'Vietnam', 'Dong', 'VND', '₫', NULL, '0'),
( 'Yemen', 'Rials', 'YER', '﷼', NULL, '0'),
( 'Zimbabwe', 'Zimbabwe Dollars', 'ZWD', 'Z\$', NULL, '0'),
( 'India', 'Rupees', 'INR', '₹', NULL, '0');


INSERT INTO `countries` ( `iso`, `name`, `abbrv`, `iso3`, `numcode`, `phonecode`) VALUES
